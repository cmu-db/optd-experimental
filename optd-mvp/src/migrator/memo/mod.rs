//! Entities related to the memo table used for dynamic programming in the our query optimization
//! framework.

pub(crate) mod m20241127_000001_fingerprint;
pub(crate) mod m20241127_000001_group;
...
pub(crate) use m20241127_000001_group as group;
