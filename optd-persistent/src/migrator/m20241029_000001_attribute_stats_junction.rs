...
impl MigrationTrait for Migration {
                ...
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(AttributeStatsJunction::Table, AttributeStatsJunction::AttrId)
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(AttributeStatsJunction::Table, AttributeStatsJunction::StatsId)
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(AttributeStatsJunction::Table).to_owned())
            .await
    }
}
