...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(catalog::index_metadata::Migration),
            Box::new(catalog::trigger::Migration),
            Box::new(catalog::constraint_metadata::Migration),
            Box::new(cost_model::statistic::Migration),
            Box::new(cost_model::versioned_statistic::Migration),
            Box::new(cost_model::statistic_to_attribute_junction::Migration),
            Box::new(cost_model::physical_expression_to_statistic_junction::Migration),
